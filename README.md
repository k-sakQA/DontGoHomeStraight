...
- 🃏 **カードめくり選択** - 裏向きの寄り道カードをめくって行き先を選ぶ
- 🔍 **ジャンル選択** - カフェ、書店、公園など多彩なカテゴリ
- 🚶‍♂️ **移動手段対応** - 徒歩、自転車、公共交通機関
- 📍 **現在地連携** - リアルタイム位置情報との統合
- 📖 **寄り道図鑑** - 到着したスポットをレアリティ付きカードとして収集
- 🔒 **Live Activity** - ロック画面に「？？？まで あと○○m」を表示（docs/LIVE_ACTIVITY_SETUP.md 参照）
- 💡 **帰り道の豆知識** - 候補がない日も「まっすぐ帰りましょう🎵」と豆知識でお見送り
